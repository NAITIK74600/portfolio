...
# Naitik Raj - Portfolio Website

💻 MCA (AI & ML) Student @ Chandigarh University  
🤖 Passionate about Artificial Intelligence, Machine Learning & Frontend Development  
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/NAITIK74600/portfolio-website.git
   ```
